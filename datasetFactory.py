...
class DatasetFactory:
    ...
    def create(self) -> None:
        ...
        # TODO - The temp dataset had fewer obsevations than actions (marginally)
        # Check that this is not always the case
        # try:
        #     assert self.actions.shape[0] == self.observations.shape[0]
        #     assert self.rewards.shape[0] == self.observations.shape[0]
        # except AssertionError:
        #     print("Shapes of actions, rewards and observations do not match")
